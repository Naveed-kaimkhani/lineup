...
import 'package:gaming_web_app/screens/team_dashboard/save_pdf_for_lineup.dart';
...
class AppPages {
 ...
 GetPage(
      name: RoutesPath.savePdfScreenForBuildLineup,
      page: () => SavePdfScreenForBuildLineup(),
    ),
