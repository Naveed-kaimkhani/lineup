...
class OrgForgotPasswordScreen extends StatelessWidget {
  OrgForgotPasswordScreen({super.key});
                      ...
                      children: [
                        ...
                        PrimaryButton(
                          onTap:
                              () => {
                                controller.isMail.value
                                    ? controller.orgResetPassword()
                                    : controller.orgSendCode(),
                              },

                          title:
                              controller.isMail.value ? "Update" : 'Send Code',
                          width: 540.4,
                          radius: 4.89.r,
