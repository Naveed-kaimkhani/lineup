  ...
  Widget build(BuildContext context) {
    return Obx(
      () => DashboardScaffold(
        ...
        bg: false,
        userImage:
            'assets/images/dummy_image.png', // Profile image for the user
        userName: 'Test User', // Display name for the user
        title:
            controller.selectTeam.value ??
            'Game-Ready', // Main title displayed in the header
