...
//     );
//   }
// void handleArrowKeyNavigation(RawKeyEvent event, int rowIndex, String colKey) {
...
// final focusNode = controller.focusNodesGrid.putIfAbsent(index, () => {})[inningNumber.toString()] ??= FocusNode();
// final controllerNode = controller.textControllersGrid.putIfAbsent(index, () => {})[inningNumber.toString()] ??=
//     TextEditingController(text: controller.autoFillData.value!.lineupp![index].innings[inningNumber]);

// //     final focusNode = controller.focusNodesGrid[index]![inningNumber]!;
// // final controllerNode = controller.textControllersGrid[index]![inningNumber]!;
//                                                                             bool
//                                                                             isLable =
//                                                                                 false;
...
//             skipTraversal:
//                 true),
//   onKey: (event) => handleArrowKeyNavigation(event, index, inningNumber.toString()),
