  ...
  Future<void> _generateAndSavePDF() async {
    try {
      ...
      if (kIsWeb) {
        ...
        // controller.updatedOutListAfterReorder.value = [];
        Get.snackbar('Success', 'PDF downloaded');
      } else {
        // Fallback for mobile/desktop (already handled in previous code)
        final directory =
          ...
          return SingleChildScrollView(
            ...
            child: ConstrainedBox(
              constraints: BoxConstraints(
                ...
                maxWidth: max(tableWidth, constraints.maxWidth),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
...
Widget _buildOutSection(double tablewidth) {
  int i = 1;
      ...
      children: [
        ...
        ClipRRect(
          ...
          child: Container(
            ...
            child: Obx(
              () =>
                  controller.updatedOutListAfterReorder.isEmpty
                      ? SizedBox()
                      : Column(
                        mainAxisSize: MainAxisSize.max,
                        children:
                            controller.updatedOutListAfterReorder
                                .map(
                                  (player) => Container(
                                    padding: const EdgeInsets.symmetric(
                                      vertical: 12,
